...
class HomeVC: UIViewController, TutorialCellDelegate {
    ...
    let content1Data:[String] = ["매일 꾸준히 커밋해보세요.", "졸업한 고양씨들은 우측 상단의", "하단의 커밋달력을 통해 일일 커밋 현황을,", "어플 사용에 익숙해 지는 겸, 간단한 미션을 완료하면"]
    let content2Data:[String] = ["고양씨의 개발환경이 4단계에 걸쳐 개선됩니다.", "냥컬렉션에서 만나볼 수 있어요.", " 리포트를 통해 매달 개발 통계를 확인할 수 있어요.", "고양이 한 마리를 데려갈 수 있어요."]
