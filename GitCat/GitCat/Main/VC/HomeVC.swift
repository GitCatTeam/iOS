...
class HomeVC: UIViewController {
    ...
    let titleData:[String] = ["커밋과 비례하는 고양이의 능력치", "나를 거쳐간 고양이들 확인하기", "달력과 레포트로 나의 커밋 돌아보기", "튜토리얼 완료하고 고양이 받자!"]
    let content1Data:[String] = ["커밋을 하면 할 수록 개선되는 고양이의 개발 환경!", "우측 상단의 수집 버튼을 통해 고양이들을 볼 수 있어요.", "하단의 커밋달력을 통해 이번 달 커밋 현황을,", "어플 사용에 익숙해 지는 겸, 간단한 미션을 완료하면"]
    let content2Data:[String] = ["꾸준한 커밋으로, 고양이의 졸업과 미래를 도와줍시다.", "과연, 나의 고양이들은 무사할까요(?)", "레포트를 통해 매달 커밋 통계를 확인할 수 있어요.", "고양이 한 마리를 데려갈 수 있어요."]
